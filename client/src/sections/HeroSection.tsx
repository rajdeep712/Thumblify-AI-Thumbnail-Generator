  ...
  return (
    <div className="relative flex flex-col items-center justify-center px-4 md:px-16 lg:px-24 xl:px-32">
      ...
      >
        ...
        <RotatingText
          texts={["Youtube", "Instagram", "Blogs", "Courses", "Podcasts"]}
          mainClassName="px-2 sm:px-2 md:px-3 move-gradient rounded-xl whitespace-nowrap text-black overflow-hidden py-0.5 sm:py-0.5 md:py-0.5 justify-center rounded-lg"
          staggerFrom={"last"}
          initial={{ y: "100%" }}
          animate={{ y: 0 }}
          exit={{ y: "-100%" }}
      ...
      >
        Stop wasting hours on design. Get high-converting thubnails in seconds
