...
export default function Navbar() {
  ...
  return (
    <>
      <motion.nav
        className="fixed top-2 z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-32 backdrop-blur"
          ...
          {isLoggedIn ? (
            <div className="relative group">
              ...
              <div className="absolute hidden group-hover:block top-6 right-0 pt-4">
                <button
                  onClick={() => logout()} // can also use just logout
